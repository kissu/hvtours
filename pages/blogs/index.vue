  ...
  <div>
    ...
    <div class="theme-hero-area theme-hero-area-half">
      <div class="theme-hero-area-bg-wrap">
        <div class="theme-hero-area-bg" style="background-image:url('https://www.happyvoyaging.com/themes/mmpt21/assets/img/activity-adult-beach-beautiful-378152_1500x800.jpeg');"></div>
        ...
        <div class="row row-col-gap" data-gutter="20">
          ...
          <div v-for="blog in posts" :key="blog.id" class="col-md-3">
                   <div class="theme-blog-item _br-4 theme-blog-item-full">
                       <a :href="`/blogs/${blog.id}-${blog.slug}`" class="theme-blog-item-link"></a>
